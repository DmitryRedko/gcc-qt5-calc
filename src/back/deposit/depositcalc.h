...
private slots:
    ...
    void extractPayoffInfo(QList<double>& partial_payoff_mass, QList<QDate>& in_dates_del);
    void extractRefillInfo(QList<double>& partial_add_mass, QList<QDate>& in_dates);
    QString calculateInterestAndTaxes(double deposit_num, double interest_num, double tax_num,
